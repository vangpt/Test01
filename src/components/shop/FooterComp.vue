        ...
        <div class="container">
            <div class="footer-head">
                <div class="foot-logo item">
                    <div class="logo">
                        <img
                            src="../../assets/imgs/logo3.jpg"
                            alt=""
                            height="70px"
                        />
                        <div>the<br /><b>gem</b></div>
                    </div>
                    <div class="desc">
                ...
                <div class="recent item">
                    ...
                    <div class="recent-detail">
                        <div class="avatar">
                            <img
                                src="../../assets/imgs/avatar-gray-mid.png"
                                alt=""
                                height="70"
                            />
                        </div>
                ...
                <div class="flickr item">
                    ...
                    <div class="squares d-flex-wrap">
                        <div class="flex-4 square">
                            <div
                                class="content"
                                style="background-color: #828e97"
                            ></div>
                        </div>
                        <div class="flex-4 square">
                            <div
                                class="content"
                                style="background-color: #5c6973"
                            ></div>
                        </div>
                        <div class="flex-4 square">
                            <div
                                class="content"
                                style="background-color: #4b565d"
                            ></div>
                        </div>
                        <div class="flex-4 square">
                            <div
                ...
                <div class="contact item">
                    ...
                    <div class="address">
                        ...
                        <br />
                        908 New Hampshire Avenue Northwest #100, Washington, DC
                        20037, United States
                    </div>
                    ...
                    <ul>
                        <li>
                            <i class="fa fa-circle"></i>&nbsp;&nbsp;<a href="#">
                                General Information For Users</a
                            >
                        </li>
                        <li>
                            <i class="fa fa-circle"></i>&nbsp;&nbsp;<a href="#">
                                Interactive Fairy Tales</a
                            >
                        </li>
                        <li>
                            <i class="fa fa-circle"></i>&nbsp;&nbsp;<a href="#">
                                Official Storybook Maker Website</a
                            >
                        </li>
                        <li>
                            <i class="fa fa-circle"></i>&nbsp;&nbsp;<a href="#">
                                Everyday Mathematics Links</a
                            >
                        </li>
                        <li>
                            <i class="fa fa-circle"></i>&nbsp;&nbsp;<a href="#">
                                Basic Knowledge and Experience</a
                            >
                        </li>
                    </ul>
                </div>
                ...
                <div class="projects item">
                    ...
                    <div class="circle">
                        <i class="fa fa-circle" style="color: #4b565d"></i>
        ...
        .useful {
            ul {
                li {
                    ...
                    display: flex;
                    align-items: center;
                    border-bottom: 1px dashed #798692;
                    a {
                        color: $gray-mid;
